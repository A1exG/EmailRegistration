...
using EmailRegistrationWebApi.Data;

namespace EmailRegistrationWebApi.Controllers
{
    public class EmailsController : ApiController
    {
        private EmailRegistrationWebApiContext db = new EmailRegistrationWebApiContext();
